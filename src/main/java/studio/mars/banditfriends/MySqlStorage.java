...
final class MySqlStorage implements AutoCloseable {
  private final JavaPlugin plugin; private final String players, friends; private Connection connection;
  MySqlStorage(JavaPlugin plugin) throws SQLException {
    ...
    players=prefix+"players"; friends=prefix+"friends";
